# 🗝️ Unit 6: Items in Truhen — `table.insert` und `table.remove`
...
Erweitere Quest 6.1: Nach dem Aufheben fragt das Programm: "Welche Slot-Nummer willst Du wegwerfen?" und entfernt das Item. Gib das fertige Inventar aus.

---
⬅️ [Unit 5](unit05-funktionen-teamwork.md) · [Übersicht](README.md) · ➡️ [Unit 7: Welt aus Räumen](unit07-raeume.md)
