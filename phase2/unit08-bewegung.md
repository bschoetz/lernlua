# 🚶 Unit 8: Bewegung in der Welt — Eingaben verarbeiten

### Was lernen wir?
Wir nehmen die Welt aus Unit 7 und machen daraus ein **interaktives Spiel**, wo der Spieler Richtungen eintippt.
...
### 🎯 Quest 8.1: Die Welt erforschen
Nimm Deine Welt aus Quest 7.1 und mache sie spielbar mit dem Code oben. Spiele und gehe durch alle Räume.
...
---
⬅️ [Unit 7](unit07-raeume.md) · [Übersicht](README.md) · ➡️ [Unit 9: Items aufheben](unit09-items.md)
