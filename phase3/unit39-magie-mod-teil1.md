# 🎯 Unit 39: Mega-Projekt Teil 1 — Die "Magie-Mod" aufbauen
...
Wir machen das in **zwei Units**: hier den Aufbau (Blöcke, Items, Rezepte), in Unit 40 die "Schmuckstücke" (Funken, Statistik, Chat).
...
Der Zauberstab macht noch nichts beim Klicken — das kommt in Unit 40.

### 🏆 Bonus
Füge ein zweites Erz hinzu (`magie:erz_blau`) mit anderer Textur, das einen anderen Staub-Typ droppt.

---
⬅️ [Unit 38](unit38-debugging.md) · [Übersicht](README.md) · ➡️ [Unit 40: Magie-Mod Teil 2](unit40-magie-mod-teil2.md)
